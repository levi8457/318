<template>
  <div class="page-container">
    <div class="page-header"><h2 class="page-title">个人设置</h2></div>
    <div class="table-card">
      <el-form label-width="120px" style="max-width:500px">
        <el-form-item label="姓名">{{ authStore.user?.realName }}</el-form-item>
        <el-form-item label="用户名">{{ authStore.user?.username }}</el-form-item>
        <el-form-item label="手机号">{{ authStore.user?.phone }}</el-form-item>
        <el-form-item label="角色">咨询师</el-form-item>
