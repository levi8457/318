<template>
  <div class="page-container">
    ...
    <div class="table-card">
      ...
      <el-table :data="filteredScripts" stripe v-loading="loading">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="{ row }">
            <el-button size="small" type="primary" @click="copyScript(row.script)">复制话术</el-button>
    ...
    <el-dialog title="话术详情" v-model="detailVisible" width="600px">
      ...
      <template #footer>
        <el-button type="primary" @click="copyScript(currentScript?.script)">复制话术</el-button>
...
async function fetchData() {
  loading.value = true;
  const res: any = await request.get('/scripts');
